...
| **`Frame 72.png`** | **Guest Guide & Amenities** | • **Before You Arrive**: 4-column editorial layout covering Policy Rundown, Contact Info, Local Proximity (Ibrahim Roza, Gol Gumbaz, Bara Kaman, etc.), Hotel Essentials (GSTIN, Fact Sheet).<br>• **Amenities**: 4-column structured checklist for Hotel, Dining, Fitness, Rooms. |
